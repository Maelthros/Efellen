...
namespace Server.Items
{
    public class MarksOfTheShadowbroker : Item
    {
        ...
        public override string DefaultDescription{ get{ return "A Mark of the Shadowbroker represents your prowess as a thief. It can be aqquired by burglars as they adventure and pilfer the pockets of their victims. The guildmaster of the thieves guild can offer many trinkets for those that would speak of rewards with them."; } }
