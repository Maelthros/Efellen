...
namespace Server
{
	...
	public class ItemSalesInfo
	{
		...
		public static ItemSalesInfo[] m_SellingInfo = new ItemSalesInfo[]
		{
			...
			new ItemSalesInfo( typeof(	Artifact_WintersGrip	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	Artifact_VampireKiller	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	Artifact_BowOfTheTribalKing	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	Artifact_CloakOfTheRogue	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	Artifact_HolyLance	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
			...
			new ItemSalesInfo( typeof(	Artifact_SerpentCoil	),	5000	,	0	,	0	,	false	,	false	,	World.None	,	Category.Artifact	,	Material.None	,	Market.None	),
