...
namespace Server.Items
{
	public class Artifact_EdgeOfDusk : GiftNoDachi
	{
		...
		public Artifact_EdgeOfDusk()
		{
			...
			ArtifactLevel = 2;
			Server.Misc.Arty.ArtySetup(this, "The duty of dusk is to shroud all in absense.");
	...
	out int direct)
		...
		public override bool OnEquip(Mobile from)
		{
			if (from.Fame < 10000)
			{
				from.SendMessage("The Edge of Dusk judges you unworthy.");
				return false;
			}
		...
		public override void OnHit(Mobile attacker, Mobile defender, double damageBonus)
		{
			...
			attacker.SendMessage(0x455, "Edge of Dusk brings forth the night!");
