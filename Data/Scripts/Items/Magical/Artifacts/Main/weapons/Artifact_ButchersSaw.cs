...
{
    public class Artifact_ButchersSaw : GiftBoneHarvester
    {
        ...
        {
            private Artifact_ButchersSaw m_Item;
            private Mobile m_Mobile;

            public ArtifactBuffEndTimer(Artifact_ButchersSaw item, Mobile mob)
        ...
        public Artifact_ButchersSaw( Serial serial ) : base( serial )
        {
        }
