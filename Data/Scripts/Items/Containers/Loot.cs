		...
		private static Type[] m_ArtyTypes = new Type[]
			{
				...
				typeof( Artifact_AcidProofRobe ), 	typeof( Artifact_AxeOfTheHeavens ), 	typeof( Artifact_CandlePoison ), 	typeof( Artifact_DreadPirateHat ), 	typeof( Artifact_GlassSword ), 	typeof( Artifact_HolyKnightsGorget ), 	typeof( Artifact_KodiakBearMask ), 	typeof( Artifact_MidnightLegs ), 	typeof( Artifact_ShieldOfInvulnerability ), 	typeof( Artifact_TotemOfVoid ), 	typeof( Artifact_BootsofLithos ),
				typeof( Artifact_Aegis ), 	typeof( Artifact_AxeoftheMinotaur ), 	typeof( Artifact_CandleWizard ), 	typeof( Artifact_DupresCollar ), 	typeof( Artifact_GlovesOfAegis ), 	typeof( Artifact_HolyKnightsLegging ), 	typeof( Artifact_MidnightTunic ), 	typeof( Artifact_RingOfHealth ), 	typeof( Artifact_ShimmeringTalisman ), 	typeof( Artifact_TotemTunic ), 	typeof( Artifact_BootsofPyros ),
				...
				typeof( Artifact_VampireKiller ), 	typeof( Artifact_CapOfTheFallenKing ), 	typeof( Artifact_EarringsOfHealth ), 	typeof( Artifact_GlovesOfDexterity ), 	typeof( Artifact_LeggingsOfBane ), 	typeof( Artifact_RingOfTheElements ), 	typeof( Artifact_TunicOfAegis ), 	typeof( Artifact_MantleofHydros ),
				typeof( Artifact_AlchemistsBauble ), 	typeof( Artifact_BeltofHercules ), 	typeof( Artifact_CaptainJohnsHat ), 	typeof( Artifact_EarringsOfTheElements ), 	typeof( Artifact_GlovesOfFortune ), 	typeof( Artifact_HoodedShroudOfShadows ), 	typeof( Artifact_LeggingsOfDeceit ), 	typeof( Artifact_RingOfTheMagician ), 	typeof( Artifact_TunicOfBane ), 	typeof( Artifact_MantleofLithos ),
				...
				typeof( Artifact_AngelicEmbrace ), 	typeof( Artifact_BladeOfInsanity ), 	typeof( Artifact_EarringsOfTheVile ), 	typeof( Artifact_GlovesOfRegeneration ), 	typeof( Artifact_HuntersArms ), 	typeof( Artifact_LeggingsOfEnlightenment ), 	typeof( Artifact_NoxNightlight ), 	typeof( Artifact_RobeOfTeleportation ), 	typeof( Artifact_SoulSeeker ), 	typeof( Artifact_TunicOfTheFallenKing ), 	typeof( Artifact_MantleofStratos ),
				typeof( Artifact_AngeroftheGods ), typeof( Artifact_CircletOfTheSorceress ), 	typeof( Artifact_EmbroideredOakLeafCloak ), 	typeof( Artifact_GlovesOfTheFallenKing ), 	typeof( Artifact_HuntersGloves ), 	typeof( Artifact_LeggingsOfFire ), 	typeof( Artifact_NoxRangersHeavyCrossbow ), 	typeof( Artifact_RobeOfTheEclipse ), 	typeof( Artifact_SpellWovenBritches ), 	typeof( Artifact_TunicOfTheHarrower ), 	typeof( Artifact_RobeofHydros ),
				...
				typeof( Artifact_ArcaneArms ), 	typeof( Artifact_CoifOfFire ), 	typeof( Artifact_EssenceOfBattle ), 	typeof( Artifact_GlovesOfThePugilist ), 	typeof( Artifact_HuntersHeaddress ), 	typeof( Artifact_LegsOfInsight ), 	typeof( Artifact_OrcChieftainHelm ), 	typeof( Artifact_RobeOfTreason ), 	typeof( Artifact_VampiricDaisho ), 	typeof( Artifact_RobeofPyros ),
				typeof( Artifact_ArcaneCap ), 	typeof( Artifact_BloodwoodSpirit ), 	typeof( Artifact_ColdBlood ), 	typeof( Artifact_EternalFlame ), 	typeof( Artifact_GorgetOfAegis ), 	typeof( Artifact_HuntersLeggings ), 	typeof( Artifact_LegsOfNobility ), 	typeof( Artifact_OrcishVisage ), 	typeof( Artifact_StaffOfPower ), 	typeof( Artifact_VioletCourage ), 	typeof( Arty_PyrosGrimoire ),
				typeof( Artifact_ArcaneGloves ), 	typeof( Artifact_BoneCrusher ), 	typeof( Artifact_ColdForgedBlade ), 	typeof( Artifact_EvilMageGloves ), 	typeof( Artifact_GorgetOfFortune ), 	typeof( Artifact_HuntersTunic ), 	typeof( Artifact_LegsOfTheFallenKing ), 	typeof( Artifact_OrnamentOfTheMagician ), 	typeof( Artifact_RobinHoodsFeatheredHat ), 	typeof( Artifact_SerpentCoil ), 	typeof( Artifact_VoiceOfTheFallenKing ), 	typeof( Arty_StratosManual ),
				typeof( Artifact_ArcaneGorget ), 	typeof( Artifact_ConansHelm ), 	typeof( Artifact_Excalibur ), 	typeof( Artifact_GorgetOfInsight ), 	typeof( Artifact_Indecency ), 	typeof( Artifact_LegsOfTheHarrower ), 	typeof( Artifact_OrnateCrownOfTheHarrower ), 	typeof( Artifact_RodOfResurrection ), 	typeof( Artifact_StaffOfTheMagi ), 	typeof( Artifact_WarriorsClasp ), 	typeof( Arty_HydrosLexicon ),
				typeof( Artifact_ArcaneLeggings ), 	typeof( Arty_BookOfKnowledge ), 	typeof( Artifact_ConansLoinCloth ), 	typeof( Artifact_CloakOfTheRogue ), 	typeof( Artifact_InquisitorsArms ), 	typeof( Artifact_LieutenantOfTheBritannianRoyalGuard ), 	typeof( Arty_OssianGrimoire ), 	typeof( Artifact_StitchersMittens ), 	typeof( Artifact_WildfireBow ), 	typeof( Arty_LithosTome ),
				typeof( Artifact_ArcaneShield ), 	typeof( Artifact_Boomstick ), 	typeof( Artifact_ConansSword ), 	typeof( Artifact_FangOfRactus ), 	typeof( Artifact_GrimReapersLantern ), 	typeof( Artifact_InquisitorsGorget ), 	typeof( Artifact_LongShot ), 	typeof( Artifact_RoyalGuardsChestplate ), 	typeof( Artifact_Stormbringer ), 	typeof( Artifact_Windsong ), 	
				typeof( Artifact_ArcaneTunic ), 	typeof( Artifact_BootsofHermes ), 	typeof( Artifact_CrimsonCincture ), 	typeof( Artifact_GrimReapersMask ), 	typeof( Artifact_InquisitorsHelm ), 	typeof( Artifact_LuckyEarrings ), 	typeof( Artifact_Pacify ), 	typeof( Artifact_RoyalGuardsGorget ), 	typeof( Artifact_WizardsPants ), 	
				typeof( Artifact_ArcanicRobe ), 	typeof( Artifact_BowOfTheTribalKing ), 	typeof( Artifact_CrownOfTalKeesh ), 	typeof( Artifact_FeyLeggings ), 	typeof( Artifact_GrimReapersRobe ), 	typeof( Artifact_InquisitorsLeggings ), 	typeof( Artifact_LuckyNecklace ), 	typeof( Artifact_PadsOfTheCuSidhe ), 	typeof( Artifact_WrathOfTheDryad ), 	
				...
				typeof( Artifact_WintersGrip ), 	typeof( Artifact_BraceletOfHealth ), 	typeof( Artifact_DarkGuardiansChest ), 	typeof( Artifact_Fortifiedarms ), 	typeof( Artifact_GuantletsOfOgreStrength ), 	typeof( Artifact_InquisitorsTunic ), 	typeof( Artifact_HolyLance ), 	typeof( Artifact_Pestilence ), 	typeof( Artifact_SamaritanRobe ), 	typeof( Artifact_TheBeserkersMaul ), 	typeof( Artifact_ZyronicClaw ), 	
				typeof( Artifact_ArmorOfFortune ), 	typeof( Artifact_BraceletOfTheElements ), 	typeof( Artifact_DarkLordsPitchfork ), 	typeof( Artifact_FortunateBlades ), 	typeof( Artifact_HammerofThor ), 	typeof( Artifact_IronwoodCrown ), typeof( Artifact_SamuraiHelm ), 	typeof( Artifact_TheDragonSlayer ), 	typeof( GwennosHarp ), 	
				typeof( Artifact_ArmorOfInsight ), 	typeof( Artifact_BraceletOfTheVile ), 	typeof( Artifact_DarkNeck ), 	typeof( Artifact_Frostbringer ), 	typeof( Artifact_HatOfTheMagi ), 	typeof( Artifact_JackalsArms ), 	typeof( Artifact_MagesBand ), 	typeof( Artifact_PixieSwatter ), 	typeof( Artifact_TheDryadBow ), 	typeof( IolosLute ), 	
				typeof( Artifact_ArmorOfNobility ), 	typeof( Artifact_BrambleCoat ), 	typeof( Artifact_DeathsMask ), 	typeof( Artifact_FurCapeOfTheSorceress ), 	typeof( Artifact_HeartOfTheLion ), 	typeof( Artifact_JackalsCollar ), 	typeof( Artifact_MagiciansIllusion ), 	typeof( Artifact_PolarBearBoots ), 	typeof( Artifact_TheNightReaper ), 	typeof( QuiverOfBlight ), 	
				typeof( Artifact_ArmsOfAegis ),	typeof( Artifact_DetectiveBoots ), 	typeof( Artifact_Fury ), 	typeof( Artifact_HellForgedArms ), 	typeof( Artifact_JackalsGloves ), 	typeof( Artifact_MagiciansMempo ), 	typeof( Artifact_PolarBearCape ), 	typeof( Artifact_ShadowDancerArms ), 	typeof( Artifact_TheRobeOfBritanniaAri ), 	typeof( QuiverOfElements ), 	
				typeof( Artifact_ArmsOfFortune ), 	typeof( Artifact_BreathOfTheDead ), 	typeof( Artifact_DivineArms ), 	typeof( Artifact_GandalfsHat ), 	typeof( Artifact_HelmOfAegis ), 	typeof( Artifact_JackalsHelm ), 	typeof( Artifact_MarbleShield ), 	typeof( Artifact_PolarBearMask ), 	typeof( Artifact_ShadowDancerCap ), 	typeof( QuiverOfFire ), 	
				...
				typeof( Artifact_ShieldOfAmaunator ), typeof( Artifact_StormKingsShield ), typeof( Artifact_RememberanceOfHereafter), typeof( Artifact_EndOfHope ), typeof( Artifact_SpellBreaker ), typeof(Artifact_UgmarLastWord),
		...
		private static Type[] m_RareItemTypes = new Type[]
			{
				...
				typeof( HairDyeBottle ),		typeof( WandOfDisenchanting ),			typeof( LesserWandOfDisenchanting ),
				typeof( MasterSkeletonsKey ),	typeof( InvulnerabilityPotion ),		typeof( FrankenJournalInBox ),
				typeof( ArmsBarrel ),			typeof( AlternateRealityMap ),			typeof( UnusualDyes ),
				typeof( NecromancerBarrel ),	typeof( DwarvenForge ),					typeof( Runebook ),	
				typeof( SmallHollowBook ),		typeof( LargeHollowBook ),				typeof( RecallRune),
				typeof( SlaversNet ),			typeof( BrokenBookcaseDeed ),			typeof( MagicPigment ),
