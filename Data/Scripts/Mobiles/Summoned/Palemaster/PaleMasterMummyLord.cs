...
namespace Server.Mobiles
{
	...
	public class PaleMasterMummyLord : BaseCreature
	{
		...
		[Constructable]
		public PaleMasterMummyLord() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public PaleMasterMummyLord( Serial serial ): base( serial )
		{
		}
